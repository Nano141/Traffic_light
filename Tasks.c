...
static void vTask3( void *pvParameters ) // train mode
{
	...
	for(;;){
		...
		PWM0_2_LOAD_R = (320000-1);  //set load value to 63999
		PWM0_2_CMPA_R = (296000-1);   //set comparator A value to 31999
		...
		PWM0_2_LOAD_R = (320000-1);  //set load value to 31999
		PWM0_2_CMPA_R = (288000-1);   //set comparator A value to 15999
		PWM0_2_CTL_R |= 0x01;		 //enable pwm
		PWM0_ENABLE_R |= (PWM_ENABLE_PWM4EN); //enable pwm values for PE4
